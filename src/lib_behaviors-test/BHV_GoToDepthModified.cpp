...
/*    FILE: BHV_GoToDepthModified.cpp                                    */
/*    DATE: Aug 1 2006                                           */
/*                                                               */
...
#include <cmath> 
#include <cstdlib>
#include "BHV_GoToDepthModified.h"
#include "ZAIC_PEAK.h"
...
BHV_GoToDepthModified::BHV_GoToDepthModified(IvPDomain gdomain) : 
  IvPBehavior(gdomain)
{
...
bool BHV_GoToDepthModified::setParam(string param, string val) 
{
  //  40,60:30,45:20,45
  if(param == "depth") {
...
IvPFunction *BHV_GoToDepthModified::onRunState() 
{
...
bool BHV_GoToDepthModified::setNextLevelDepth()
{
  bool ok;
...
bool BHV_GoToDepthModified::incrementLevelDepth()
{
  m_curr_index++;
...
string BHV_GoToDepthModified::expandMacros(string sdata)
{
  // =======================================================
